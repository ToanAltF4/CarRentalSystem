...
('Tesla Model X', 'Model X Long Range', 'Tesla', '51A-444.44', 100.00, 560, 10.00, 2800000, 'INACTIVE', 7, 'https://images.unsplash.com/photo-1566055909643-a51b4271aa47?w=800', 'Premium electric SUV with iconic falcon-wing doors', 4),
-- VinFast
...
('Hyundai Ioniq 6', 'Ioniq 6 Standard', 'Hyundai', '29A-222.33', 77.40, 614, 7.50, 1400000, 'INACTIVE', 5, 'https://images.unsplash.com/photo-1681469787982-d1b3e2e0f31e?w=800', 'Aerodynamic electric sedan with lowest drag coefficient in class', 1),
