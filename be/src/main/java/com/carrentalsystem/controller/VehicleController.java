...
public class VehicleController {
    ...
    @PostMapping
    @Operation(summary = "Create a new vehicle", description = "Add a new electric vehicle to the fleet")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Update vehicle status", description = "Change vehicle status (AVAILABLE, RENTED, MAINTENANCE)")
    @ApiResponses(value = {
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Delete vehicle", description = "Remove a vehicle from the fleet")
    @ApiResponses(value = {
